...
/*enum ps4_packet_index {
  packet_index_analog_stick_lx = 4,
  packet_index_analog_stick_ly = 5,
  packet_index_analog_stick_rx = 6,
  packet_index_analog_stick_ry = 7,

  packet_index_button_standard = 8,
  packet_index_button_extra = 9,
  packet_index_button_ps = 10,

  packet_index_analog_l2 = 11,
  packet_index_analog_r2 = 12,

  packet_index_status = 33
};
