...
**
*******************************************************************************/
uint16_t GAP_ConnOpen(const char* p_serv_name, uint8_t service_id, bool is_server, BD_ADDR p_rem_bda,
...
*******************************************************************************/
uint16_t GAP_ConnBTWrite(uint16_t gap_handle, BT_HDR* p_buf);
