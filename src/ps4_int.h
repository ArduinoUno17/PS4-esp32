...
/*enum ps4_control_packet_index {
  ps4_control_packet_index_small_rumble = 7,
  ps4_control_packet_index_large_rumble = 8,

  ps4_control_packet_index_red = 9,
  ps4_control_packet_index_green = 10,
  ps4_control_packet_index_blue = 11,

  ps4_control_packet_index_flash_on_time = 12,
  ps4_control_packet_index_flash_off_time = 13
};*/
